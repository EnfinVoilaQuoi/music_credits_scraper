...
def start_enrichment(app):
    ...
    def start_enrichment():
        ...
        dialog.destroy()
        run_enrichment(app, selected_sources, force_update=force_update,
...
def run_enrichment(app, sources: List[str], force_update: bool = False,
    ...
    def enrich():
        try:
            ...
            app.root.after(0, lambda s=summary: report.show_scrollable_report(app, 
            ...
            app.root.after(0, lambda: messagebox.showerror("Erreur", f"Erreur lors de l'enrichissement: {error_msg}"))
        finally:
            ...
            try:
                ...
                pass
            app.root.after(0, lambda: app.enrich_button.configure(
                state="normal",
